...
def checklines(lines):
    ...
    line_counter = 0                           # counts the lines scanned by this thread
...
def read_file(infile, worker_threads):
    ...
    i = 0                   # iterator
    split = 100             # number of lines each thread should handle at a time
    ...
    with open(infile) as f:
        for line in f:
            ...
            if i > split:
                ...
                while active >= worker_threads:
                    print("too many threads")
                    time.sleep(1)                                                           # ensures the max thread count is not exceeded
                
                threads.append(threading.Thread(name="filterthread", target=checklines, args=(wordlist,)))       # creates a new thread to process the wordlist
...
if __name__ == "__main__":
    ...
    outfile = "/home/zack/Desktop/Hons Project/test_processed.txt"                    # path and name of output file
    infile = "/home/zack/Desktop/Hons Project/unfiltered1000.txt"                     # path and name of input file
    invalid_outfile = "/home/zack/Desktop/Hons Project/test_processed_invalid.txt"    # filepath for invalid words
